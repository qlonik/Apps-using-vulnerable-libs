...
export const report: CordovaManualAnalysisReport = {
  ...
  files: {
    'body/0005': {
      ...
      type: 'bundle',
      match: [
        { name: 'angular', version: '1.4.3', isGuess: false, minified: false },
        { name: 'underscore', version: '1.7.0', isGuess: false, minified: false },
        { name: 'lodash', version: '2.4.2', isGuess: false, minified: false },
        { name: 'ng-animate', version: '1.4.3', isGuess: true, minified: false },
        { name: 'ng-sanitize', version: '1.4.3', isGuess: true, minified: false },
        { name: 'angular-ui-router', version: '0.2.13', isGuess: false, minified: false },
        { name: 'localForage', version: '1.2.0', isGuess: false, minified: false },
        { name: 'angular-translate', version: '2.6.1', isGuess: false, minified: false },
        {
          name: 'ng-cordova',
          version: '0.1.12-alpha',
          isGuess: false,
          minified: false,
          comments: 'cordova plugins',
        },
        {
          name: 'jssha',
          isGuess: true,
          minified: true,
          comments: 'http://caligatio.github.com/jsSHA/',
        },
        {
          name: 'immutable',
          isGuess: true,
          minified: false,
          comments: 'global variable is exposed',
        },
        {
          name: 'jquery',
          version: '2.2.2',
        ...
        { name: 'imgcache.js', version: '1.0.0', isGuess: true, minified: false },
        { name: 'ng-youtube-embed', isGuess: true, minified: false },
        { name: 'add to homescreen', version: '3.2.2', isGuess: true, minified: false },
        {
          name: 'pdfjs',
          version: '1.1.337',
          isGuess: false,
          minified: false,
          comments: 'build #: 61f9052. included twice',
        },
        {
          name: 'ngprogress',
          version: '1.1.2',
        ...
        { name: 'ionic', version: '1.1.0', isGuess: false, minified: false },
        { name: 'angular-ionic', version: '1.1.0', isGuess: true, minified: false },
        {
        ...
        { name: 'jQuery Waypoints', version: '2.0.5', isGuess: false, minified: false },
        { name: 'angular-pdf', version: '1.0.2', isGuess: false, minified: false },
        {
          name: 'Angulartics',
          version: '0.17.2',
          isGuess: false,
