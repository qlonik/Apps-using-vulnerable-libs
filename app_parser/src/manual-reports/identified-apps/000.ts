...
export const report: CordovaManualAnalysisReport = {
  ...
  files: {
    'body/0001': {
      ...
      type: 'bundle',
      match: [
        { name: 'angular', version: '1.5.7', file: '0001.json', isGuess: true, minified: true },
        { name: 'jquery', version: '2.2.4', isGuess: true, minified: true },
        { name: 'moment', version: '2.10.6', isGuess: true, minified: true },
        { name: 'lodash', version: '4.14.1', isGuess: true, minified: true },
        // there is more
      ],
    },
    'body/0002': { location: 'body', id: '0002', type: 'business-logic' },
    'body/0003': { location: 'body', id: '0003', type: 'business-logic' },
    'head/0000': {
      location: 'head',
      id: '0000',
      type: 'single-lib',
