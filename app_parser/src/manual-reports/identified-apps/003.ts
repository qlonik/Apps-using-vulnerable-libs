...
export const report: CordovaManualAnalysisReport = {
  ...
  files: {
    ...
    'head/0001': {
      ...
      type: 'bundle',
      match: [
        { name: 'ionic', version: '1.2.4-nightly-1917', isGuess: false, minified: false },
        { name: 'angular', version: '1.4.3', isGuess: false, minified: false },
        { name: 'angular-animate', version: '1.4.3', isGuess: false, minified: false },
        { name: 'angular-sanitize', version: '1.4.3', isGuess: false, minified: false },
        { name: 'angular-ui-router', version: '0.2.13', isGuess: false, minified: false },
        { name: 'ionic-angular', version: '1.2.4-nightly-1917', isGuess: false, minified: false },
      ],
    },
    'head/0002': {
      location: 'head',
    ...
    'head/0005': {
      ...
      id: '0005',
      type: 'unknown',
      match: { name: 'angular-validation', isGuess: true, minified: false },
    },
    'head/0006': {
      location: 'head',
      id: '0006',
    ...
    'head/0008': {
      ...
      id: '0008',
      type: 'unknown',
      match: { name: 'HumanizeDuration', isGuess: true, minified: false },
    },
    'head/0009': {
      location: 'head',
      id: '0009',
      type: 'single-lib',
      match: { name: 'angular-timer', version: '1.3.4', isGuess: false, minified: true },
    },
    'head/0010': {
      location: 'head',
      id: '0010',
